...
@Service("ImplementedSecondMondeDuMobile")
public  class implementedSecondMondeDuMobile implements InterfaceMondeDuMobile 
{
	...
	public void listerEntreprises(){		
		for(Entreprise eleEntreprise : privobjListEntreprise) {			
			...
			System.out.println(oTel.getPrivsFT_NomFournisseur()+ " (seconde implementation) : ");
	...
	public void listerPortablesEntreprise(Entreprise argEnt) {
		...
		System.out.println(" (seconde implementation) - " + eleVP.getPrivsVP_MarquePortable());
	}
