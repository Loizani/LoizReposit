...
public class ControleurApplication {
	...
	public String listUsers(ModelMap model) {
		...
		List<EntityUser> users = userService.findAllUsers();
	...
	public String saveUser(@Valid EntityUser user, BindingResult result,
			ModelMap model) {
	...
	public String updateUser(@Valid EntityUser user, BindingResult result,
	...
	public List<EntityUserProfile> initializeProfiles() {
