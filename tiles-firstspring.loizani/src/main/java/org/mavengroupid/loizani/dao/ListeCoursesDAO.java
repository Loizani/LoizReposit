...
public class ListeCoursesDAO implements IListeCoursesDAO {
    ...
    public void modifierCourse(final Course pCourse) {
        ...
        if (lRowCount != 1) {
            ...
            final javax.persistence.Query lHQuery = lQuery.unwrap(javax.persistence.Query.class);
            final String lSql = lHQuery.toString();
            System.out.println("********************* classe ListeCoursesDAO > methode modifierCourse >  lSql : " +lSql);
