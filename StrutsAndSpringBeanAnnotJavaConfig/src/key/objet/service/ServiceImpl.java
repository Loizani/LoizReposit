...
public class ServiceImpl implements InterfaceService {
	...
	public ServiceImpl() {
		super();
		System.out.println("Tentative instanciation (avec argument iDAO) de la classe ServiceImpl");
		IDAO =  new fillDataDaoImplem();
		IDAO.initialisation();
		System.out.println("Fin instanciation (avec argument iDAO) de la classe ServiceImpl");
	}
